...
"""Part 2: Electron Motion in the Magnetic Trap"""
...
if __name__ == "__main__":
    ...
    # Finding the maximum and minimum frequencies greater than zero
    max_frequency = max(frequencies)
    min_frequency = min(f for f in frequencies if f > 0)

    print(f"Maximum Frequency: {max_frequency} MHz")
    print(f"Minimum Frequency (greater than zero): {min_frequency} MHz")
